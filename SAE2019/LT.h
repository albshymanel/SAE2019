...
#define LEX_BYTE		't'	// лексема для byte
#define LEX_STRING		't'	// лексема для string
#define LEX_BOOL		't'	// лексема для bool
#define LEX_ID			'i'	// лексема для идентификатора
#define LEX_LITERAL		'l'	// лексема для литерала
#define LEX_FUNCTION	'f'	// лексема для function
#define LEX_DEF			'd'	// лексема для def
#define LEX_RETURN		'r'	// лексема для return
#define LEX_PRINT		'p'	// лексема для print
#define LEX_MAIN		'm'	// лексема для main
#define LEX_IF          'c' // лексема для if condition
...
#define LEX_REMAINDER	'v' //лексема для %
...
namespace LT		// таблица лексем
{
	...
	Entry writeEntry(					// заполнить строку таблицы лексем (экземпляр строки, лексема, индекс таблицы, строка)
		Entry& entry,
