...
#define FST_ID 2,	\
	...
	FST::RELATION('y', 0), FST::RELATION('z', 0), FST::RELATION('A', 0), FST::RELATION('B', 0), FST::RELATION('C', 0), FST::RELATION('D', 0),\
	FST::RELATION('E', 0), FST::RELATION('F', 0), FST::RELATION('G', 0), FST::RELATION('H', 0), FST::RELATION('I', 0), FST::RELATION('J', 0),\
	FST::RELATION('K', 0), FST::RELATION('L', 0), FST::RELATION('M', 0), FST::RELATION('N', 0), FST::RELATION('O', 0), FST::RELATION('P', 0),\
	FST::RELATION('Q', 0), FST::RELATION('R', 0), FST::RELATION('S', 0), FST::RELATION('T', 0), FST::RELATION('U', 0), FST::RELATION('V', 0),\
	FST::RELATION('W', 0), FST::RELATION('X', 0), FST::RELATION('Y', 0), FST::RELATION('Z', 0),\
	\
...
#define FST_BYTELIT 2,	\
	...
	FST::RELATION('7', 1), FST::RELATION('8', 1), FST::RELATION('9', 1), FST::RELATION('0', 1), FST::RELATION('b', 1), FST::RELATION('o', 1)),\
	FST::NODE()\
...
#define FST_LEFTBRACKETS 2,	\
	FST::NODE(1, FST::RELATION('[', 1)),\
	FST::NODE()

#define FST_RIGHTBRACKETS 2,	\
	FST::NODE(1, FST::RELATION(']', 1)),\
	FST::NODE()
